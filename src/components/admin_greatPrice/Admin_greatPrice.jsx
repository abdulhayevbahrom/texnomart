...
import './Admin_greatPrice.css'

function Admin_greatPrice() {
  ...
  const sendToBackend = (e) => {
    ...
    axios
      .post('http://localhost:8000/greatPrice/greatPrice', {
  ...
  return (
    <div className='admin_greatPrice'>
      <form>
        <p>Mahsulot nomi*</p>
...
export default Admin_greatPrice
