...
import './Admin_toplamlar.css'

function Admin_toplamlar() {
  ...
  const sendToBackend = (e) => {
    ...
    axios
      .post('http://localhost:8000/toplamlar/toplamlar', {
...
export default Admin_toplamlar